                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h1>STANDARD<span style="float:right">
                                                @foreach($PropertySubscription->where('id',19)->values() as $a)
                                                    {{ $a->Price}}€
                                                @endforeach</span>
                                            </h1>
                                            <hr class="mt-4 mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                                    <input type="radio" class="larger" name="slot" id="slot" value="19" <?=$bcheck?> ><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                                </div>
                                            </div>
                                            <!---->
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h1>FEATURED <span style="float:right">
                                                @foreach($PropertySubscription->where('id',20)->values() as $a)
                                                    {{ $a->Price}}€
                                                @endforeach
                                                </span>
                                            </h1>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                                    <input type="radio" class="larger" name="slot" value="20" id="slot2" <?=$acheck?>><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                                </div>
                                            </div>
                                            <!---->
                                        </div>
