                           ...
                           <div class="row">
                            ...
                            <div class="row" style="margin-top:2%">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 featured" >
                                 <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                           ...
                                           name="slot" value="8" id="slot2" <?=$acheck?>><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                        <h1>STANDAERD <span style="float:right">@foreach($PropertySubscription->where('id',9)->values() as $a)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                           <input type="radio" class="larger" name="slot" id="slot" value="9" 
