...
<form method="get" action="{{url('Auto_store')}}" id="uploadForm" enctype="multipart/form-data">
                     <input type="hidden" value="4" name="no" id="no">
<!--=========================MAIN STARTS======================================-->
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                           <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h3 style="color:red"><b>Automobiles \ Describe your vehicle<span style="color:rgb(113, 113, 113);font-size:12px">(Optional)</span></b></h3>
                          ...
                          <div class="row mt-4">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <h3>What's great about your vehicle? You can describe the decoration, the neighborhood, what's nearby, etc...</h3>
          ...
          <textarea name="description" id="description" class="form-control" rows="10"
            placeholder="Describe Your Vehicle Here...">{{ isset($property) ? $property->description : '' }}</textarea>
          </div>
        </div>
                            <!---->
                             <!---->
                    ...
                    <!--        <a href="{{url('Auto_store')}}?no=2" class="btn btn-large btn-block yellow-btn next font-roboto -->
                ...
                <a href="{{url('Auto_store')}}?no=2" class="btn btn-large custom-btn  btn-block yellow-btn next font-roboto 
