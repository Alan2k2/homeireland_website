...
if(isset($data))
{
    ...
    //  dd($data->subcription_type);
   
    if($data->subcription_type=='19')
    {
        $acheck="checked";
    }
    if($data->subcription_type=='20')
    {
                      ...
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                           <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h1>Automobiles \ Choosed  Plan </h1>
                            ...
                            <div class="row" style="margin-top:2%">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 featured" >
                                 <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                           ...
                                           name="slot" value="1" id="slot2" <?=$acheck?>><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                        <h1>STANDAERD <span style="float:right">@foreach($PropertySubscription->where('id',20)->values() as $a)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                           <input type="radio" class="larger" name="slot" id="slot" value="2" 
                                           <?=$bcheck?>><b style="padding:10px" >&nbsp;&nbsp;SELECT</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
