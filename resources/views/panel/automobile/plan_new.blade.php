                ...
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 brtop-30 brbottom-30">
                                ...
                                <ul class="font-roboto light tab fs-5">
                                       ...
                                       <li class="tablinks "   
                                        ...
                                        <li class="tablinks" id="eu6" >
                                             <a>
                                                <span class="post-link-ico"></span>
                                               Billing                                             <span class="completed-tick"></span>                                            </a>
                                        </li>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 rhs-post brtop-30 brbottom-30">
                        ...
                        <form name="myForm" method="get" action="{{url('Auto_store')}}" id="uploadForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                         @csrf   
...
if(isset($data))
{
    ...
    if($data->subcription_type==8)
    {
        $acheck="checked";
    }
    if($data->subcription_type==9)
    {
...
?>
                           ...
                           <div class="row">
                            ...
                            <div class="row" style="margin-top:2%">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 featured" >
                                    <div class="card">
                                        <div class="card-body">
                                            <h1>STANDARD<span style="float:right">
                                                @foreach($PropertySubscription->where('id',8)->values() as $a)
                                                    {{ $a->Price}}€
                                                @endforeach
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                                    <input type="radio" class="larger" name="slot" id="slot" value="8" <?=$bcheck?> ><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                                </div>
                                            </div>
                                            <!---->
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h1>FEATURED <span style="float:right">
                                                @foreach($PropertySubscription->where('id',9)->values() as $a)
                                                    {{ $a->Price}}€
                                                @endforeach
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                                    <input type="radio" class="larger" name="slot" value="9" id="slot2" <?=$acheck?>><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                                </div>
                                            </div>
                                            <!---->
                                        </div>
                    ...
                    <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">
                                <!--<a href="{{url('Auto_store')}}?no=4" class="btn btn-large btn-block yellow-btn next font-roboto -->
                ...
                <!--<a href="{{url('Auto_store')}}?no=4" class="btn btn-large custom-btn  btn-block yellow-btn next font-roboto -->
