...
<h1 style="color:red"><?=Session::get('title')?> \ Location</h1>

                        <form method="get" action="{{url('price')}}" id="uploadForm" enctype="multipart/form-data">
...
<!--=========================MAIN STARTS======================================-->
                 ...
                 <select class="form-control searchbar filter-search-county county-ulster mt-4 " name="county" data-gmap-addr-donator="5" id="counties" required>
                    ...
                    @endforeach
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                 <section>
                                     <span>City</span>
                                    <input class="form-control valid  mt-4" type="text" value="{{isset($data)?$data->city:''}}" required data-gmap-addr-donator="0" id="street" 
                                    name="city2" data-gtm-form-interact-field-id="0" placeholder="City"aria-invalid="false">
                                 </section>
                             </div>
                         </div>
                         <!--row 2-->
                         <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                 <section>
                                     <span>Town</span>
                                      <input class="form-control valid mt-4" type="text" value="{{isset($data)?$data->town:''}}" required data-gmap-addr-donator="0" id="town" placeholder="Town"name="town" data-gtm-form-interact-field-id="0" aria-invalid="false">
                                 </section>
                             </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                 <section >
                                     <span>Street</span>
                                    <input class="form-control valid mt-4" type="text" value="{{isset($data)?$data->street:''}}" required data-gmap-addr-donator="0" id="street" name="street"placeholder="Street" data-gtm-form-interact-field-id="0" aria-invalid="false">
                                 </section>
                             </div>
                         </div>
                         <!--row 3-->
                         <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                 <section >
                                     <span>EIR Code</span><br><br>
                                    <input class="form-control valid" type="text" value="{{isset($data)?$data->eir_code:''}}" required data-gmap-addr-donator="0" id="eir_code" name="eir_code"placeholder="EIR Code" data-gtm-form-interact-field-id="0" aria-invalid="false">
                                 </section>
                             </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                 <section style="display:flex">
                                     @php
           $disp_check="";
           $disp=isset($data)?$data->location_disp_flag:''; 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px">i don't want to display the Exact Address</span> 
                           ...
                           <!--<div class="row">-->
                           <!--  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">-->
                           <!--      <small>For exact location please add the below data from gmap</small><br><br>-->
                           <!--      <section style="display:flex">-->
                           <!--          Latitude&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                           <!--         <input class="form-control valid" type="text" value="{{isset($data)?$data->Latitude:''}}" required data-gmap-addr-donator="0" id="eir_code" name="Latitude"placeholder="Latitude" data-gtm-form-interact-field-id="0" aria-invalid="false">-->
                           <!--      </section>-->
                           <!--  </div>-->
                           <!--   <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">-->
                           <!--       <br><br>-->
                           ...
                           <!--          Longitude&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                           <!--         <input class="form-control valid" type="text" value="{{isset($data)?$data->Longitude:''}}" required data-gmap-addr-donator="0" id="eir_code" name="Longitude"placeholder="Longitude" data-gtm-form-interact-field-id="0" aria-invalid="false">-->
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">
                                ...
                                <!--    aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>-->
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">
                                     ...
                                     <!--added custom-button class name to the button-->
