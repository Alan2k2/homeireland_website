...
<div class="preloader">
        ...
        <section class="postWrapper clearfix">
            <div class="container">
                        <form name="myForm" method="get" action="{{url('contact1')}}" id="uploadForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                         @csrf   
...
?>
                            <div class="row" style="margin-top:2%">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 featured" >
                                 <div class="card">
                                    <div class="card-body">
                                       <h1>Ad Details<span style="float:right">€ <?=$ads->price?></span></h1>
                                        <hr class="mt-4 mb-4">
                                        <div class="row">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  mt-4"><center>
                                ...
                                light brbottom-30 icon-link icon-link-hover  mt-4"  style=""><center><b>&nbsp;&nbsp;Proceed To checkout</b></center>
                                </button>
                                </form>
                                </center>
                            </div>
