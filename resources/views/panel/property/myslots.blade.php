...
/*added media query for the radio button*/
                      ...
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                           ...
                           <div class="row">
                               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
                                 <h1 style="color:red"><b>My Slot</b></h1>
                                <center><h1 style="color:red">Purchased Slot</h1></center>
                             ...
                             <div class="col-lg-12 d-none d-md-block">
                                 ...
                                 <thead>
                                        <tr class="fs-4">
                                         ...
                                         <th scope="col">Used Slot</th>
                                         <th scope="col">Remaining Slot</th>
                                        </tr>
                                      </thead>
                                      ...
                                      <tbody>
                                           @forelse($Purchased_slot as $slot)
                                        <tr class="fs-5">
                                          
                                          <td>{{$loop->iteration}}</td>
                                          <td>{{$slot->Name}}</td>
                                          <td>{{$slot->slot_number}}</td>
                                           <td>{{$slot->used_slot}}</td>
                                            <td>
                                                <?php
                                                $remaining_slot=($slot->slot_number)-($slot->used_slot);
                                                ?>
                                                {{$remaining_slot}}</td>
                                        </tr>
                                        @empty
                                   <tr>
                                       <td></td>
                                        <td></td>
                                       <td align="center fs-5" >
                                       <p style="color:red">You Have Not Purchased Any Slot.</p>
                                   </td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;</td>
                                   </tr> 
...
@forelse($Purchased_slot as $slot)
    <div class="col-6 col-md-4 col-lg-3 mb-3 d-block d-md-none">
        <div class="card h-100 shadow-sm">
            <div class="card-body fs-5">

                <p><strong>SI.NO:</strong> {{$loop->iteration}}</p>
                <p><strong>Slot Name:</strong> {{$slot->Name}}</p>
                <p><strong>Total Slot:</strong> {{$slot->slot_number}}</p>
                <p><strong>Used Slot:</strong> {{$slot->used_slot}}</p>
                <p><strong>Remaining:</strong> {{ $slot->slot_number - $slot->used_slot }}</p>
    ...
    <div class="col-12">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                <p class="text-danger">You Have Not Purchased Any Slot.</p>
            </div>
        </div>
    </div>
...
@endforelse
                           ...
                           <div class="row">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-3">
                                ...
                                <center><h1>Choose Your Slot</h1></center>
...
?>
                            <div class="row" style="margin-top:2%">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 featured" >
                                 <div class="card">
                                    <div class="card-body">
                                        <h1>5 SLOTS <span style="float:right">€ <?=$price_array[2]?></span></h1>
                                        <hr class="mt-4 mb-4">
                                        <div class="row">
                                                    ...
                                                    <li style="color:green"><b>3X MORE AD VIEWS</b></li>
                                                     <li >Listed Below agent ads</li>
                                                      <li >Extra large ad format</li>
                                                       <li >5 ads can List </li>
                                                        <li ><?=$duration_array[2]?> days Live<span style="color:rgb(113, 113, 113)"></span></li>
                                                </ul>
                                                </div>
                                        </div>
                                        <!---->
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                                <input type="radio" id="slot3" class="larger"  name="slot" value="3"<?=$c?>><b style="padding:10px" >&nbsp;&nbsp;SELECT</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 featured" >
                                 <div class="card">
                                    <div class="card-body">
                                       <h1>10 SLOTS <span style="float:right">€ <?=$price_array[3]?></span></h1>
                                        <hr class="mt-4 mb-4">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <ul>
                                                    <li style="color:green"><b>3X MORE AD VIEWS</b></li>
                                                     <li>Listed Below agent ads</li>
                                                      <li>Extra large ad format</li>
                                                       <li>10 ads can List </li>
                                                        <li><?=$duration_array[3]?> days Live<span style="color:rgb(113, 113, 113)"></span></li>
                                                </ul>
                                                </div>
                                        </div>
                                        <!---->
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                           <input type="radio" class="larger"   id="slot" name="slot" value="4" 
                                           <?=$a?>><b style="padding:10px">&nbsp;&nbsp;SELECT</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                        <h1>15 SLOTS <span style="float:right">€ <?=$price_array[4]?></span></h1>
                                        <hr class="mt-4 mb-4">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <ul>
                                                   <li style="color:green"><b>3X MORE AD VIEWS</b></li>
                                                     <li>Listed Below agent ads</li>
                                                      <li>Extra large ad format</li>
                                                       <li>15 ads can List </li>
                                                        <li><?=$duration_array[4]?> days Live<span style="color:rgb(113, 113, 113)"></span></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-radio">
                                           <input type="radio" id="slot2" class="larger" name="slot" value="5"<?=$b?> ><b style="padding:10px" >&nbsp;&nbsp;SELECT</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  mt-4"><center>
                                ...
                                light brbottom-30 icon-link icon-link-hover  mt-4" style="background-color:red"><center><b>&nbsp;&nbsp;Proceed To checkout</b></center>
                                </button>
                                </form>
                                </center>
                            </div>
