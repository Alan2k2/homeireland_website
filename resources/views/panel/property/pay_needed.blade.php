...
<section class="postWrapper clearfix">
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="clearfix col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            ...
                            <ul class="font-roboto light tab sidebar">
                                ...
                                @if(Session::get('main_cat')!=3 && Session::get('main_cat')!=4 && Session::get('main_cat')!=6)
            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 rhs-post brtop-30 brbottom-30">
                ...
                <form name="myForm" method="get" action="{{url('location')}}" id="uploadForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                    @csrf
    ...
    <input type="hidden" name="city" value="{{ $city }}">
                    ...
                    $a1 = $b = "";
                    if(isset($data)) {
                        if($data->subcription_type == 11) {
                            $a1 = "checked";
                        }
                        if($data->subcription_type == 12) {
                            $b = "checked";
                        }
                        if($data->subcription_type == 13) {
                            $a1 = "checked";
                        }
                        if($data->subcription_type == 14) {
                            $b = "checked";
                        }
                        if($data->subcription_type == 15) {
                            $a1 = "checked";
                        }
                        if($data->subcription_type == 16) {
                            $b = "checked";
                        }
                        if($data->subcription_type == 17) {
                            $a1 = "checked";
                        }
                        if($data->subcription_type == 18) {
                            $b = "checked";
                        }
                    }
                    @endphp
                    ...
                    <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                        ...
                        <div class="row" style="margin-top:2%">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 featured plan-card">
                                ...
                                if($main_cat == 9)
                                {
                                    $standardPlan = $PropertySubscription->where('id', 11)->where('payment_mode', 1)->first();
                                }
                                elseif($main_cat == 10)
                                {
                                    $standardPlan = $PropertySubscription->where('id', 13)->where('payment_mode', 1)->first();
                                }
                                elseif($main_cat == 11)
                                {
                                    $standardPlan = $PropertySubscription->where('id', 15)->where('payment_mode', 1)->first();
                                }
                                elseif($main_cat == 12)
                                {
                                    $standardPlan = $PropertySubscription->where('id', 17)->where('payment_mode', 1)->first();
                                }
                                else{
                                    echo "error";
                                }
                                    ...
                                    <div class="card-body">
                                        <h1 class="plan-title">
                                            ...
                                            <span class="plan-price">
                                                @if($main_cat == 9)
                                                    ...
                                                    @foreach($PropertySubscription->where('id',11)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                                
                                                @elseif($main_cat == 10)
                                                
                                                    @foreach($PropertySubscription->where('id',13)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                                
                                                @elseif($main_cat == 11)
                                                
                                                    @foreach($PropertySubscription->where('id',15)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                                
                                                @elseif($main_cat == 12)
                                                
                                                    @foreach($PropertySubscription->where('id',17)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                        ...
                                        <div class="plan-select">
                                            <div class="custom-radio">
                                                @php
                                                    if($main_cat == 9){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="11" id="slot" <?=$a1?>>';
                                                    }
                                                    if($main_cat == 10){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="13" id="slot" <?=$a1?>>';
                                                    }
                                                    if($main_cat == 11){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="15" id="slot" <?=$a1?>>';
                                                    }
                                                    if($main_cat == 12){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="17" id="slot" <?=$a1?>>';
                                                    }
                                                @endphp
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 featured plan-card">
                                ...
                                if($main_cat == 9)
                                {
                                    $featuredPlan = $PropertySubscription->where('id', 12)->where('payment_mode', 1)->first();
                                }
                                elseif($main_cat == 10)
                                {
                                    $featuredPlan = $PropertySubscription->where('id', 14)->where('payment_mode', 1)->first();
                                }
                                elseif($main_cat == 11)
                                {
                                    $featuredPlan = $PropertySubscription->where('id', 16)->where('payment_mode', 1)->first();
                                }
                                elseif($main_cat == 12)
                                {
                                    $featuredPlan = $PropertySubscription->where('id', 18)->where('payment_mode', 1)->first();
                                }
                                else{
                                    echo "error";
                                }
                                    ...
                                    <div class="card-body">
                                        <h1 class="plan-title">
                                            ...
                                            <span class="plan-price">
                                                @if($main_cat == 9)
                                                    ...
                                                    @foreach($PropertySubscription->where('id',12)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                                
                                                @elseif($main_cat == 10)
                                                
                                                    @foreach($PropertySubscription->where('id',14)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                                
                                                @elseif($main_cat == 11)
                                                
                                                    @foreach($PropertySubscription->where('id',16)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                                
                                                @elseif($main_cat == 12)
                                                
                                                    @foreach($PropertySubscription->where('id',18)->values() as $a)
                                                        {{ $a->Price}}€
                                                    @endforeach
                                        ...
                                        <div class="plan-select">
                                            <div class="custom-radio">
                                                @php
                                                    if($main_cat == 9){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="12" id="slot2" <?=$a1?>>';
                                                    }
                                                    if($main_cat == 10){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="14" id="slot2" <?=$a1?>>';
                                                    }
                                                    if($main_cat == 11){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="16" id="slot2" <?=$a1?>>';
                                                    }
                                                    if($main_cat == 12){
                                                       echo '<input type="radio" class="larger" name="stnfet" value="18" id="slot2" <?=$a1?>>';
                                                    }
                                                @endphp
                                                <!--<input type="radio" class="larger" name="stnfet" value="10" id="slot2">-->
