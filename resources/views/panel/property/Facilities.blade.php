    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="clearfix col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            ...
                            <ul class="font-roboto light tab sidebar">
                                ...
                                <li class="tablinks active" id="eu4">
                                    <a>
                                        <span class="post-link-ico"></span>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 rhs-post brtop-30 brbottom-30">
                ...
                <form method="get" action="{{url('description')}}" id="uploadForm" enctype="multipart/form-data">
                    ...
                    <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                        <div class="row">
                            <div class="col-12">
                                <h3 style="color:red">{{Session::get('title')}} \ Facilities</h3>
                            </div>
                        ...
                        <div class="row">
                            ...
                            // Use facilities passed from controller
                            $allFacilities = $facilities->toArray();
                            
                            // Prepare checked flags dynamically
                            $checkedFlags = [];
                            foreach ($allFacilities as $facility) {
                                $checkedFlags[$facility['name']] = in_array($facility['name'], $selectedFacilities) ? 'checked' : '';
                            }
                            ?>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 row1">
                                <label class="checkbox-container">
                                    <input type="checkbox" name="fa[]" value="{{ $facility['name'] }}" <?= $checkedFlags[$facility['name']] ?? '' ?>>
                        ...
                        <section class="button-section">
                            <div class="button-container">
                                <a href="{{url('detail')}}?id=2" class="btn btn-large custom-btn yellow-btn next font-roboto light brbottom-30 icon-link icon-link-hover left-align">
...
<script type="text/javascript">
    ...
    var HAFE = {};
    var generalError = 'Please check indicated fields';
