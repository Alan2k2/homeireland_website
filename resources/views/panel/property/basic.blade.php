            ...
            <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 brtop-30 brbottom-30">
                    <div class="clearfix lhs-post-links border-radius-3 nav-txt" style="height:80px;">
                        ...
                        <!--    <a href="#" class="font-roboto regular "> Navigation111</a>-->
                        <!--</div>-->
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 rhs-post brtop-30 brbottom-30">
                        ...
                        <form method="get" action="{{url('location')}}?" id="uploadForm" enctype="multipart/form-data">
                         @csrf   
                       ...
                       <main>
                           <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h3>Choose your ad type</h3>
                                 <p>These are the categories that your ad is going to be listed in.</p>
                             </div>
                           </div>
                           <section >
                               <!---->
                               ...
                               <!---->
                                <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="1" required><label>Residential Rent</label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="2"><label>Sharing (room)</label>
                                     </aside>
                                 </div>
                            </div>
                            <!---->
                             <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="3"><label>Commercial Rent</label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="4"><label>Parking Rent</label>
                                     </aside>
                                 </div>
                            </div>
                            <!---->
                             ...
                             <section >
                               ...
                               <!---->
                                <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="5"><label>Residential Sale</label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="6"><label>Commercial Sale</label>
                                     </aside>
                                 </div>
                            </div>
                            <!---->
                             <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="7" ><label>Parking Sale</label>
                                     </aside>
                                 </div>
                           ...
                           <section >
                               <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h3 class="mt-4">Holiday Homes</h3>
                               </div>
                               <!---->
                                <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="8"><label>Holiday Homes</label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
