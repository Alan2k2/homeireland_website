    ...
    <select class="form-control"  name="tax" data-gmap-addr-donator="5" >
                            ...
                            <div class="row" >
                                 ...
                                 <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 mt-4 floor2">
                                             <div class="mt-0">
                                       <h4>Floor area</h4> 
                                         <input type="text" placeholder="Floor area" class="form-control mb-4"> 
                                    </div>
                                         </div>
                                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-4 floor2" style="padding-top:8px">
                                              <span style="font-size:14px"></span> 
                                              <select class="form-control mb-4 mt-4"  id="plotAreaUnit" name="plot_area_unit">
                             ...
                             <div class="row" id="serviced_office">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-4">
                                       ...
                                       <div style="display:flex;margin-top:15px">
                                              ...
                                              <input type="checkbox" class="larger "placeholder="€" id="auction"> &nbsp;
                             ...
                             <div class="row" >
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     ...
                                     <div>
                                        ...
                                        <input type="checkbox" class="larger mt-4">
                                        </center>
                                     </div>
                                     @endif
                                 </div>
                                  ...
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     ...
                                     <div style="display:flex;margin-top:0%">
                                         <h4 class="mt-4">+1 person OK</h4>
                                                             ...
                                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;             
     <input class=" larger mt-4" type="checkbox"  >
                                     </div>
                                 </div>
                                 @endif
                            </div>
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     ...
                                     <div>
                                        ...
                                        <h4 style="padding-right:10px" class="mt-2">Preference</h4> 
                                         &nbsp;&nbsp;
                                        <input type="radio" class="larger1" name="pref"><span class="mt-3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Female only&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        <input type="radio" class="larger1" name="pref"><span class="mt-3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Male only&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        <input type="radio" class="larger1" name="pref"><span class="mt-3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Either&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
        ...
        <!--                   </section>-->
         ...
         <section class="button-section">
                      ...
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                           <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h3>Add property details</h3><br><br>
...
24/7&nbsp;&nbsp;&nbsp;
                           ...
                           <div class="row ml-4">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ml-4">
                                 ...
                                 <input  style="margin-left:12px"type="number" class="mt-4 form-control" placeholder="Enter a Number">
        ...
        <!--            <div class="row">-->
        <!--                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">-->
        <!--                        <a href="{{url('price')}}?id=2" class="btn btn-large btn-block yellow-btn save font-roboto -->
        <!--                        light brbottom-30 icon-link icon-link-hover" ><b><i class="fa fa-arrow-left" -->
        <!--                            aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>-->
        <!--                    </div>-->
        <!---->
...
function myFunction() {
    ...
    if(property_select=="4")

{
   $(".housetype").show();
}    
     if(property_select!="6"&&property_select!="5"){
      ...
      if(property_select=="5")

{
   $(".ber").hide();
}    
}
// =====on prop type change end================
function ImgUpload() {
  var imgWrap = "";
  var imgArray = [];
