                ...
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 brtop-30 brbottom-30">
                                ...
                                <ul class="font-roboto light tab sidebar">
                                       ...
                                       <li class="tablinks "   
                                        ...
                                        <li class="tablinks"   id="eu4">
                                            ...
                                            <li class="tablinks active" id="eu5" >
                                                <a >
                                                <span class="post-link-ico"></span>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 rhs-post brtop-30 brbottom-30">
                                    ...
                                    @endif  
  @if(session::get('main_cat')==81)
<form method="get" action="{{url('pay_holiday_homes')}}" id="uploadForm" enctype="multipart/form-data">
@elseif(session::get('main_cat')==9||session::get('main_cat')==10||session::get('main_cat')==11||session::get('main_cat')==12)
<!--<form method="get" action="{{url('pay_needed')}}" id="uploadForm" enctype="multipart/form-data">-->
<form method="get" action="{{url('media')}}" id="uploadForm" enctype="multipart/form-data">
@else
                        <form method="get" action="{{url('media')}}" id="uploadForm" enctype="multipart/form-data">
                      @endif
                      ...
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                           <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h3 style="color:red" ><b><?=Session::get('title')?> \ Describe your property<span style="color:rgb(113, 113, 113);font-size:12px">(Optional)</span></b></h3>
                          ...
                          <div class="row mt-4">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <h3>What's great about your property? You can describe the decoration, the neighborhood, what's nearby, etc...</h3>
      ...
      placeholder="Describe Your Property Here...">{{ isset($property) ? $property->description : '' }}</textarea>
                            ...
                            <div class="row" style="margin-top:0%">
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-4">
                                        ...
                                        <h4 style="color:rgb(113, 113, 113)">
                                             Please do not discriminate on the grounds of housing assistance,gender, civil status, family status, sexual orientation, religion,age, disability, race or traveller community.
                                        </h4>
        ...
        <!--                        @if(session::get('main_cat')==4||session::get('main_cat')==7||session::get('main_cat')==9||session::get('main_cat')==10||session::get('main_cat')==11||session::get('main_cat')==12)-->
        <!--                        <a href="{{url('property_details')}}?id=2" class="btn btn-large btn-block yellow-btn next font-roboto -->
        <!--                        light brbottom-30 icon-link icon-link-hover" ><b><i class="fa fa-arrow-left" -->
        <!--                            aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>-->
        <!--                            @else-->
        <!--                    <a href="{{url('Facilities')}}?id=2" class="btn btn-large btn-block yellow-btn next font-roboto -->
        <!--                        light brbottom-30 icon-link icon-link-hover" ><b><i class="fa fa-arrow-left" -->
        <!--                            aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>-->
        <!--                            @endif-->
        <!--                    </div>-->
        ...
        <!--                   </section>-->
                     ...
                     <div class="button-container">
                        @if(session::get('main_cat')==7||session::get('main_cat')==9||session::get('main_cat')==10||session::get('main_cat')==11||session::get('main_cat')==12)
                                <a href="{{url('detail')}}?id=2" class="btn btn-large custom-btn btn-block yellow-btn next font-roboto 
                                light brbottom-30 icon-link icon-link-hover" ><b><i class="fa fa-arrow-left" 
                                    aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>
                                    @elseif(session::get('main_cat')==4)
                            <a href="{{url('price')}}?id=2" class="btn btn-large custom-btn btn-block yellow-btn next font-roboto 
                                light brbottom-30 icon-link icon-link-hover" ><b><i class="fa fa-arrow-left" 
                                    aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>
                                    @else
                            <a href="{{url('Facilities')}}?id=2" class="btn btn-large custom-btn btn-block yellow-btn next font-roboto 
                                light brbottom-30 icon-link icon-link-hover" ><b><i class="fa fa-arrow-left" 
                                    aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;PREV</b></a>
                                    @endif
