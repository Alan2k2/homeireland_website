...
if(isset($data))
{
    ...
    if($data->subcription_type==7)
    {
        $a1="checked";
    }
    if($data->subcription_type==10)
    {
...
?>
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                           <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h1 style="color:red" ><?=Session::get('title')?> \ Choose Your Plan</h1>
                            ...
                            <div class="row" style="margin-top:2%">
                                <!---->
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 featured" >
                                 <div class="card">
                                    <div class="card-body">
                                    <h1>STANDAERD <span style="float:right">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <ul>
                                                <li >90 days Live<span style="color:rgb(113, 113, 113)"></span></li><br>
                                                </ul>
                                                </div>
                                        </div>
                                        <!---->
                                        <div class="row">
                                           ...
                                           <input type="radio" class="larger" name="slot" id="slot" value="7" 
                                           <?=$b?> disabled><b style="padding:10px">&nbsp;&nbsp;</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1>FEATURED <span style="float:right">
                                          @foreach($PropertySubscription->where('id',10)->values() as $a)
                                        ...
                                        <div class="row">
                                           ...
                                           name="slot" value="10" id="slot2" <?=$a1?> disabled><b style="padding:10px">&nbsp;&nbsp;</b>
                                            </div>
                                        </div>
                                        <!---->
                                    </div>
                            ...
                            <!---->
                        <!--next button-->
                        <!-- button need to be updated-->
        <!--                   <section>-->
        <!--            <div class="row">-->
        <!--                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">-->
        <!--                        <a href="{{url('media')}}?id=2" class="btn btn-large btn-block yellow-btn next font-roboto -->
        ...
        <!--button style and section changed -->
         <section class="button-section">
                     <div class="button-container">
                        <a href="{{url('media')}}?id=2" class="btn btn-large custom-btn next font-roboto light brbottom-30 icon-link icon-link-hover left-align">
