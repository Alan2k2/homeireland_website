<?php
// GetFullAddress("WebServer","P85 YH98");
...
<!--=========================MAIN STARTS======================================-->
                      <main style="border: 1px solid rgb(221, 221, 221);padding:10px">
                          <div class="row">
                               ...
                               <!---->
                                <div class="row">
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-4">
                                     <div>
                                         <label>Enter Eircode or Address</label>
                                         <input type="text" size="50" placeholder="e.g: D06 1234 or 1 Main Road">
                                     </div><br>
                                  <span style="color:rgb(113, 113, 113);">   Can’t find your eircode or address?</span><br>

<a href="{{url('location')}}?id=2"> Enter address manually</a> 
                                 </div>
                            ...
                            <div class="row">
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <aside><i class="fa fa-exclamation-circle" aria-hidden="true"></i>&nbsp;
                                       <label> Eircode is the quickest way to enter your address. We won’t ever display it on any ads</label>
                                       </aside>
                               </div>
                               </div>
                    ...
                    <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">
                                <a href="{{url('basic')}}?id=2" class="btn btn-large btn-block yellow-btn save font-roboto 
