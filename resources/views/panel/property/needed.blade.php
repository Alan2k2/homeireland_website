                           ...
                           <section >
                               ...
                               <!--row1-->
                                <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="9" required><label>Residential Properties</label>
                                     </aside>
                                 </div>
                                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                            ...
                            <!---row 2 -->
                             <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="10"><label>Sharing-Rooms</label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                            ...
                            <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="11"><label>Commercial Properties </label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                            ...
                            <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
                                     <aside>
                                         <input type="radio" name="main_cat" value="12"><label>Parking</label>
                                     </aside>
                                 </div>
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-4">
