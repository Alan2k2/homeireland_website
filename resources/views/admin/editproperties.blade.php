...
/*added the below media query for the weekkly,monthly radio button*/
...
<div class="row">
                                 ...
                                 <h3 class="text-danger">{{$property->main_name}}</h3>
                               </div>
                               </div>
                               <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
 ...
 ?>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="card">
        <div class="card-body" >
            <form form method="get" action="{{url('admin/properties_details')}}" id="uploadForm" enctype="multipart/form-data"style="padding:20px">
               <center>
            ...
            <form method="get" action="{{url('admin/properties_details')}}" id="uploadForm" enctype="multipart/form-data">
        </div>
       </div>
    </div>
  </div>
...
<!--=========================MAIN STARTS======================================-->
                      <main style="border: 0px solid rgb(221, 221, 221);">
                          ...
                          @if(Session::get('main_cat') != 7)
                            <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <h3 class="text-danger">2.Price</h3>
                               </div>
                               </div>
                           @endif
                                    ...
                                    Session::get('main_cat') == 9||Session::get('main_cat') == 10||Session::get('main_cat') == 11||Session::get('main_cat') == 12
                                     ...
                                     <div class="row" >
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 asidecontainer ">
                                     
                                     <aside class="aside1">
                                         @if (Session::get('main_cat') == 10|| Session::get('main_cat') == 1 ||Session::get('main_cat') == 8)
                                          <h3 class="mt-4 heading"> Rent €</h3>
                                         @else
                                         ...
                                         ?>
                                        <div style="display:flex;" class="radiocontainerMain">
                                            <div style="" class="radiocontainer1"> <input type="radio" name="price_type" value="monthly" <?=$a?>><label>Monthly</label></div>
                                            <div style="" class="radiocontainer2"> <input type="radio" name="price_type" value="weekly" <?=$b?>><label>Weekly</label></div>
                                        
                                          
                                          @if(Session::get('main_cat') == 9||Session::get('main_cat') == 11||Session::get('main_cat') == 12)
                                          <div style="" class="radiocontainer3">
                                          <input type="radio"  name="price_type" value="Buy" <?=$c?>><label class="radiocontainer3Input">Buy</label>
                                          </div>
                                          @endif
                                         </div>
                                     </aside>
                                   ...
                                   @endif
                                     ...
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                                         ...
                                         <h3 class="mt-4 heading">Rent collection</h3>
                                         <?php
                                         $mcheck=$wcheck="";
                                         if($property)
                                         {
                                         ...
                                         ?>
                                         <input type="radio" name="rent_coll"value="Monthly"<?=$mcheck?> checked><label class="checkoutlabel">Monthly</label>
                                          <input type="radio" name="rent_coll"value="Weekly"<?=$wcheck?>><label class="checkoutlabel">Weekly</label>
                                    
                                         </div>
                                         <!---->
                                         <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4 ">
                                     
                                         <h3 class="mt-4 heading">Bedroom Available</h3>
                                        <!--======================-->
                       ...
                       ?>
                          <option value="0" <?=$sc?>>No</option>
                            <option value="1" <?=$dc?>>Yes</option>
                                         ...
                                         {
                                         ?>
                                         <section class="bedrooms bedrooms2">
                                             <div class="bedroom">
                                         <aside >
                                         <div class="row" >
                                             <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 mt-4">
                                     ...
                                     <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 inputcontainerr">
                          ...
                          <option value="0">No</option>
                            <option value="1">Yes</option>
                                  ...
                                  @if(Session::get('main_cat') == 3||Session::get('main_cat') == 4||Session::get('main_cat') == 6) 
                                          <!--row 3-->
                                     <div class="row" >
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-0">
                                     
                                     <input type="text" hidden name="main_cat" id="main_cat" value="{{session('main_cat')}}">
                                     
                                         <h3 class="mt-4 heading"> For Sale or To Let </h3>
                                         <?php
                                         $a=$b=$c=$d=$e="";
                                         ...
                                         ?>
                                              ...
                                              <select class="form-control selecthead"  id="choose_prop" name="for_let_sale" >
                                     ...
                                     <section id="forlet">
                                       <div class="row" style="margin-top:2%">
                                          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 mt-4 forlet">
                                             <div class="mt-0">
                                                <h4 id="rent" class="heading">Rent €</h4> 
                                         ...
                                         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-4 forlet hr" style="padding-top:8px">
                                              ...
                                              ?>
                                              <select class="form-control mb-4 mt-4 selecthead1"  id="plotAreaUnit" name="price_type" >
                        <option value="">-- Select property type--</option>
                                      ...
                                      <div class="row forlet" style="margin-top:2%">
                                          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                           ...
                                           <input type="checkbox" class="larger" name="price_apn"value="1" <?=$d?>> &nbsp;
                                                   &nbsp;&nbsp; <h4 class="mt-2 heading heading2">Price on application</h4>
                                           </div>
                                              </div>
                                              </div>
                        ...
                        <input type="text" placeholder="Location" class="form-control mb-4" name="auction_location2" value="{{$property->auction_location}}"> 
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-4">
                                        ...
                                        ?>
                                          ...
                                          <select class="form-control selecthead2" id="selling_type" name="selling_type">
                          ...
                          <option value="2" <?=$b?>>For Sale by Public Auction</option>
                            <option value="3" <?=$c?>>For Sale by Public Tender</option>
                              <option value="4" <?=$d?>>For Sale by Private Tender</option>
                                          ...
                                          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-4">
                                              <div class="mt-0">
                                                   <h4 class="heading pricehead">Price1</h4> 
                                         ...
                                         <!---new row-->
                                          ...
                                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-2">
                                           ...
                                           <h4 class="heading">Price on application</h4>
                                           </div>
...
<script type="text/javascript" src="{{ asset('js/sdk.homeireland.js') }}"></script>
<script type="text/javascript">     
