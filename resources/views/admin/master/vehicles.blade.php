  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form>
           <input type="text" placeholder="Enter Vehicle Name" name="county"class="form-control" size="15" required><br>
...
<input type="hidden" name="a" class="form-control mt-2" required value="11">
                <input type="hidden" name="b" class="form-control mt-2" required value="12">
            <!-- Buttons -->
            ...
            <div class="col-lg-2 col-md-2 col-6 mb-2 d-flex align-items-end">
               <!--<a href="{{url('admin/property_enquiries')}}?a=51&&b=26"><button type="button" class="clear-btn btn btn-secondary btn-sm w-100" onclick="document.querySelector('form').reset();">Clear</button></a>-->
                <button type="button" style=" background-color:#6c757d;color:white;" class="clearbtn" onclick="document.querySelector('form').reset();"> <a href="{{url('admin/vehicle')}}?a=11&&b=12"> Clear </a></button>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Vehicles
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">auto_name</th>
                                            ...
                                            <tr class="datas">
                                                 ...
                                                 <td class="text-center">{{$tst->auto_name}}</td>
                                                 ...
                                                 <td class="text-center">
                                                        ...
                                                        <span class="slider round"></span>
                                                          ...
                                                          <td align="center"><a href="delete_vehicle/{{$tst->id}}"><button class="btn btn-sm btn-danger " onclick="return confirm('Are you sure you want to delete this item?');">Delete</button></a></td>                     
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
