  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form>
           <input type="text" placeholder="Enter New Facility" name="facilities" class="form-control" size="15" required><br>
      </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Facilities
                                    </div>
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                            @foreach($facilities as $tst)
                                            <tr class="datas">
                                             
                                                 <td class="text-center text-muted">{{ $facilities->firstItem() + $loop->index }}</td>
                                                  
                                                 <td class="text-center">{{$tst->facilities}}</td>
                                                 ...
                                                 <td class="text-center">
                                                        ...
                                                        <span class="slider round"></span>
                                                          ...
                                                          <td align="center"><a href="delete_facilities/{{$tst->id}}"><button class="btn btn-sm btn-danger " onclick="return confirm('Are you sure you want to delete this facility?');">Delete</button></a></td>                     
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
