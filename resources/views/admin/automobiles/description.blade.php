...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <h3 class="text-danger">{{$data->aname}} / Describe your property</h3>
    </div>
</div>
                          ...
                          <!---->
                            <div class="row" style="margin-top:0%">
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-4">
                                      ...
                                      <textarea name="description" id="editor">{{isset($data)?$data->description:''}}</textarea>
    ...
    CKEDITOR.replace('editor');
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">
                                 <a href="{{url('admin/automobile_details/')}}/?no=2" class="btn btn-large btn-block yellow-btn next font-roboto 
