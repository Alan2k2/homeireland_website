...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <h3 class="text-danger">{{$property->main_name}} / Describe your property</h3>
    </div>
</div>
<form method="get" action="{{url('admin/property_media')}}" id="uploadForm" enctype="multipart/form-data">
                      ...
                      <main style="border: 0px solid rgb(221, 221, 221);padding:10px">
                          ...
                          <div class="row mt-4">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <h6>What's great about your property? You can describe the decoration, the neighborhood, what's nearby, etc...</h6>
                          ...
                          <!---->
                            <div class="row" style="margin-top:0%">
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-4">
                                      ...
                                      <textarea name="description" id="editor">{{isset($property)?$property->description:''}}</textarea>
   
                                        <!--<textarea id="description" rows="20" cols="100"  name="description"-->
                                        <!--placeholder="Describe Your Property Here..."></textarea>-->
                              <script>
    CKEDITOR.replace('editor');
                    ...
                    <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  mt-4">
                                ...
                                <a href="{{url('admin/Facilities')}}?a=2&&b=4" class="btn btn-large btn-block yellow-btn next font-roboto 
