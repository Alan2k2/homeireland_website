...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <h3 class="text-danger">{{$data->main_name}} / Media</h3>
    </div>
</div>

<form method="POST" action="{{url('admin/media_store')}}" id="uploadForm" enctype="multipart/form-data">
                          ...
                          <input type="hidden" value="{{isset($data)?$data->id:''}}" name="property_id" id="property_id">
                                      ...
                                      <!--</div>-->
                                      <!--    <div class="col-md-6">-->
                                                               <!--width="320px" height="240px" style="max-width: 320px"; removed this from the img  width="320" height="240" from second img-->
                                      @if(isset($data->main_image))
                                     
                                      <img src="{{asset('uploads/properties/'.$data->main_image)}}" id="imagePreview" alt="Image" class="mainImg"  />
                                      @else
                                      <img src="{{asset('website/images/no-image.jpg')}}" class="mainImg" id="imagePreview" 
                                      alt="Image"    />    
                                      @endif                             
  ...
  <div class="row">
       <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 custombtn" >
          <a href="{{url('admin/property_description')}}?a=2&&b=4" class="btn btn-large btn-block yellow-btn next font-roboto 
