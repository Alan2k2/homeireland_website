...
<div class="">
  ...
  <div id="myCarousel" class="carousel slide-adv" data-ride="carousel">
    <!-- Indicators -->
...
<section class="container">
    <div class="text-center">
        <img src="{{asset('uploads/paymentlogo/p.svg')}}" alt="Los Angeles" class="img-fluid" style="width:100px;height:110px">
        <h1 class="mainhead text-danger"><b>OUR PREMIUM ADVERTISEMNTS</b></h1>
    </div>

    <div class="d-none mb-6 d-md-block mt-4">
    <div class="row" style="margin-top:40px">
        @foreach($Advertisement as $a)
            <div class="col-md-6 mb-4"> <!-- Adjusted to col-md-4 for 3 cards per row -->
                <div class="box_slot"> <!-- Added styling for better appearance -->
                    <p class="title_properties text-center mb-3">
                        {{ $a->page_name }}
                        <span class="float-end">€{{ $a->price }}</span>
                    </p>
                    <ul class="list-unstyled">
                        <li><strong>Duration:</strong> {{ $a->duration }} days</li>
                        <li><strong>Position:</strong> {{ $a->position }}</li>
                    </ul>
                </div>
            </div>
        @endforeach
        ...
        <div class="row">
            @foreach($Advertisement as $a)
                <div class="col-12 mb-3">
                    <div class="box_slot">
                        <p class="title_properties" style="text-align: center;">
                            {{ $a->page_name }}
                            <span class="float-end">€{{ $a->price }}</span>
                        </p>
                        <ul class="list-unstyled">
...
<div class="container-fluid enquiry-margin vh-100">
  <div class="row h-100">
    <!-- Image on the left side -->
    <div class="col-md-6 p-0 d-none d-sm-block">
      <img src="{{asset('uploads/AD_BANNER/aab.jpeg')}}" alt="Image" class="img-fluid h-100 w-100 object-fit-cover" style="object-fit: contain;">
    </div>

    <!-- Form on the right side -->
    <div class="col-md-6 d-flex justify-content-center align-items-center p-4">
      <div class="form-container1 w-100">
        @if ($message = Session::get('success'))
          <div>
            <strong>{{ $message }}</strong>
          </div>
    ...
    font-weight: 600;font-size: x-large;">ENQUIRY TO HOMEIRELAND</h2>
        <form action="{{url('contact-enquiry')}}" method="post">
          @csrf
          <div class="form-group">
            <label for="name" class="h4">Name</label>
