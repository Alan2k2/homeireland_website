...
<html lang="en">
  ...
  <body>
    ...
    <nav class="site-nav login-navbar">
      <div class="container">
        <div class="menu-bg-wrap">
          <div class="site-navigation">
            <a href="{{url('/')}}" class="logo m-0 float-start"> <img src="{{asset('website/images/homeireland_logo1.png')}}" width="50%">
      ...
      <div class="row mt-5">
        <div class="col-12 text-center">
          ...
          <p>
            ...
            <a href="https://bethelsoft.com">Bethelsoft.com</a>
