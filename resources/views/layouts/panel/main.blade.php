...
<header class="header" style="background-color:#d3111a;height:110px;">
    <div class="container-fluid">
        <div class="col-lg-4 col-md-3 col-sm-3 col-xs-6 homeireland-logo">
        ...
        <div class="col-lg-8 col-md-9 col-sm-9 col-xs-6 rhs-linklist">
            <ul class="font-roboto regular">
                ...
                <li class="menu-ico">
                    <a href="#" title="Menu">
                        <i class="fa-solid fa-bars" style="font-size:25px;"></i> <!-- Menu Icon -->
                    </a>
                    <div class="dropdown-link clearfix mt-2">
                        <div class="userName font-nunito semi-bold menu">Menu</div>
                        <ul>
        <!-- New Links in the Same Format -->
        <li>
            <a href="{{url('/myprofile')}}">Profile</a>
        </li>
        <li>
            <a href="{{url('/display_property')}}">Properties</a>
        </li>
        <li>
            <a href="{{url('/Automobiles')}}">Automobiles</a>
        </li>
        <li>
            <a href="{{url('/display_ads')}}">Advertisement</a>
        </li>
        <li>
...
<nav class="navbar">
        ...
        <div class="navbar-links" id="navbar-links">
            <ul>
                ...
                <!-- changed the menu bar to the following below-->
               ...
               <li class="tablinks" onclick="openCity(event, 'event4')">
                            <a class=" font-roboto regular add-prop w-100">
                             <span style="font-size:18px;">Chat</span>
                            </a>
                        </li>
                 @if(Auth::user()->role === "agent")
                    <li class="tablinks" ><a  href="{{url('myslots')}}" >Slot</a> </li>
                    @endif
                <!--<li><a href={{url('/home')}}>Chat</a></li>-->
                <li><a href={{url('/Enquiries')}}>Enquiries</a></li>
                <li><a href={{url('/payments_history')}}>Payment History</a></li>
                
                <li><a style=" height:40px;width:40px; background-color: #ffff; color: #d3111a; font-weight: bold; border: 0px;" href="" onclick="event.preventDefault(); document.getElementById('logout-form').submit(); ">Logout</a></li>
                
            </ul>
        </div>
        <a href="javascript:void(0);" class="close-button" id="close-button" style="text-decoration:none;">&times;</a>
    </nav>
</header>
...
<!--                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 div1">-->
...
<!--                </div>-->
<!--                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-top-15 zeroPadding">-->
<!--                    <ul class="social">-->
<!--                        <li>-->
...
<!--                        <li>-->
<!--                            <a href="" target="_blank" rel="noopener">-->
<!--                                <img data-hafe-el-name="imglazyload" src="https://assets.helloaddress.com/ui/build/images/1x1.jpg" data-original-src="https://assets.helloaddress.com/ui/build/images/playstore-ico.png" alt="Helloaddress Android App" -->
<!--                                title="Helloaddress Android App">-->
<!--                            </a>-->
<!--                        </li>-->
              
<!--                        <li>-->
<!--                            <a href="https://itunes.apple.com/in/app/hello-address/id965147046?ls=1&mt=8" target="_blank" rel="noopener">-->
<!--                                <img data-hafe-el-name="imglazyload" src="https://assets.helloaddress.com/ui/build/images/1x1.jpg" data-original-src="https://assets.helloaddress.com/ui/build/images/applestore-ico.png" alt="Helloaddress iOS App" -->
<!--                                title="Helloaddress iOS App">-->
<!--                            </a>-->
<!--                        </li>-->
<!--                    </ul>-->
<!--                </div>-->
...
<!--            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:5px 0px;">-->
<!--                <p class="font-roboto light brtop-10" style="margin:5px 0px;">HomeIreland.com is an exclusive real estate portal for Ireland, owned by the ** group. It caters to residential, commercial, industrial and agricultural properties within the Country.-->
    ...
    <div class="container">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="widget widgefooter">
             ...
             <p class="margin-bottom:5px;" style="color:#fff;text-align:justify; line-height:1.3rem;">The dream of your vehicle awaits, we pride ourselves on being a trusted partner in the real estate market. With years of experience , we are committed to helping you find the perfect home. Our company values integrity, transparency, and customer satisfaction above all else. We offer a wide range of services, from personalized home searches to expert advice on buying and selling. Join us at Your Dream Vehicle Awaits, where your real estate dreams become reality.</p>
...
<!--          <address style="color:#fff !important;">11 Elgon Walk,-->
<!--Ardkeen Village,Waterford,Ireland-->
<!--X91 C9F3</address>-->
          <ul class="list-unstyled links">
            <!--<li><a href="tel://11234567890">0858544057</a></li>-->
            <!--<li><a href="tel://11234567890">0899488580</a></li>-->
